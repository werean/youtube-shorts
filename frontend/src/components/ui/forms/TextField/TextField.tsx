...
import { VisuallyHidden } from "../../foundation/VisuallyHidden/VisuallyHidden";
...
export function TextField({
  ...
  return (
    <div className={cn("ui-text-field", containerClassName)}>
      {hideLabel ? (
        <VisuallyHidden>
      ...
      >
        ...
        <input
          id={fieldId}
          className={cn("ui-text-field-input", className)}
          required={required}
